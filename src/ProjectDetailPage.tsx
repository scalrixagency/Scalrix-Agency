        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-7xl font-extrabold leading-[1.1] text-white mb-6 tracking-tight relative z-10">
                Project: <br />
                <span className="text-[#fef08a]">ABD Bake & Freeze</span>
              </h1>
              <p className="text-white/90 text-lg max-w-lg mb-8 leading-relaxed relative z-10">
                A complete digital transformation: From zero online existence to a professional brand identity, GMB optimization, and Meta ads management.
              </p>
            </motion.div>
              ...
              <div className="relative w-full max-w-[650px] xl:max-w-[800px] mx-auto lg:mx-0 mt-[-40px] md:mt-6 lg:mt-0 xl:scale-110 xl:origin-right">
                ...
                <div className="relative aspect-[16/10] bg-slate-900 rounded-[20px] md:rounded-[24px] p-2.5 md:p-4 shadow-2xl flex flex-col">
                  <div className="flex-1 w-full rounded-[10px] md:rounded-[12px] overflow-hidden bg-slate-100 relative">
                    ...
                    <img 
                      src="https://i.postimg.cc/FRBzvpp9/Screenshot-2026-04-29-022306.png" 
                      alt="ABD Bake & Freeze Dashboard" 
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="text-3xl font-bold text-slate-900 tracking-tight mb-6">
              The Digital Blueprint: Building a Food Brand from Zero
            </h2>
            <div className="text-lg text-slate-600 leading-relaxed space-y-4">
              <p>
                The challenge was to establish a professional digital footprint for a startup with zero online existence. The task involved building everything from scratch—creating a brand identity, setting up social platforms, and developing a system to attract local customers.
              </p>
            </div>
          </motion.div>
        </div>
            ...
            {[
              {
                ...
                desc: "Logo design, professional FB/Insta profile setup, and color palette consistency.",
              },
              {
                title: "Content Strategy",
                desc: "Designing 8-10 professional posters and creating high-engagement Reels.",
              },
              {
                title: "Online Presence & Leads",
                desc: "GMB setup, Meta Business Suite integration, and WhatsApp lead-gen funnel.",
              },
            ].map((sol, idx) => (
              <motion.div
                key={idx}
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 -mt-24">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6">
            {[
              {
                id: 1,
                src: "https://i.postimg.cc/bYKTrWj7/image-f2eabdb3.png",
                caption: "Premium Logo & Brand Identity",
                imageClass: "object-contain p-2 md:p-4"
              },
              {
                id: 2,
                src: "https://i.postimg.cc/jj5NZ4b6/Whats-App-Image-2026-04-28-at-11-22-15-PM-(1).jpg",
                caption: "Visual Campaign Design",
                imageClass: "object-cover"
              },
              {
                id: 3,
                src: "https://i.postimg.cc/MGvMyZ0S/Whats-App-Image-2026-04-28-at-11-22-15-PM.jpg",
                caption: "AI Video & Reels",
                imageClass: "object-cover"
              },
              {
                id: 4,
                src: "https://i.postimg.cc/T3fTp8Z1/Screenshot-2026-04-28-094137.png",
                caption: "Professional Setup",
                imageClass: "object-cover object-top"
              },
              { 
                id: 5,
                src: "https://i.postimg.cc/4NmXcbdg/Screenshot-2026-04-28-092637.png",
                caption: "GMB Optimization",
                imageClass: "object-contain p-1 md:p-2"
              },
              { 
                id: 6,
                src: "https://i.postimg.cc/wBprBdM9/Whats-App-Image-2026-04-29-at-2-04-37-AM.jpg",
                caption: "Business Integration",
                imageClass: "object-cover"
              },
            ].map((item, idx) => (
              <motion.div
                ...
                className="bg-white rounded-2xl md:rounded-[40px] p-1.5 md:p-3 flex flex-col group shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 hover:shadow-lg transition-all duration-300"
              >
